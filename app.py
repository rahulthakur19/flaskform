...
def insert_data(name, phone, email, college):
    new_user = User(name=name, phone=phone, email=email, college=college)
...
def modify_data(the_id, col_name, user_input):
    ...
    elif col_name == 'college':
        the_user.college = user_input 
